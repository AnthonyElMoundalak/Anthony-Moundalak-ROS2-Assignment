...
class TemperatureLogger(Node):
    def __init__(self):
        ...
        # log_dir = os.path.expanduser('~/Anthony-Moundalak-ROS2-Assignment/ros2ws')
        # self.log_file_path = os.path.join(log_dir, 'log_file.txt')
        # check = os.path.isfile(self.log_file_path)
        # if (not check):
            # None
